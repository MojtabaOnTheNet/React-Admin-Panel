      ...
      <Table className="overflow-hidden text-lg">
        <TableHeader>
          <TableRow>
            ...
            <TableCell className="w-30 text-center">نوع سوال</TableCell>
            <TableCell className="w-30 text-center">دسته</TableCell>
            <TableCell className="w-30 text-center">
              قسمتی از متن سوال
            </TableCell>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell className="w-30 text-center">پرسش</TableCell>
            <TableCell className="w-30 text-center">محصولات</TableCell>
            <TableCell className="w-30 text-center">
              قسمتی از متن سوال برای محصول
            </TableCell>
